...
Composite CI (Monte Carlo, 10K draws, pinned seed): **[88, 96]**
Tier under v20 bands: lower bound 88 ≥ 80 → **Gold** (no tier cap; §10 quadrant cap on Risk applies — Risk = 90 already reflects the 1.5-point composite penalty).
...
Composite CI: **[78, 90]**
Tier under v20 bands: lower bound 78 → **Silver** (60–79 band).
...
Composite CI: **[92, 98]**
Tier under v20 bands: lower bound 92 → **Gold** (ALR cap does not apply for military — military is not in ALR scope; Risk is not capped for this domain).
...
Composite CI: **[76, 90]**
Tier under v20 bands: lower bound 76 → **Silver** (60–79 band).
...
Composite CI: **[73, 87]**
Tier under v20 bands: lower bound 73 → **Silver** (60–79 band).
...
Composite CI: **[51, 73]**
Tier under v20 bands: lower bound 51 → **Bronze** (40–59 band — note: point 62.45 is in the Silver band, but lower-bound tiering keeps it Bronze; the gap surfaces in disclosure).
...
Composite CI: **[18, 39]**
Tier under v20 bands: lower bound 18 < 40 → **Flagged**. Finding: `COUNTERFEIT` (multiple inconsistencies across Identity, Material, with the movement-calibre mismatch as primary).
...
12. *AP 5516 worked example.* v10.1 §5 reads PCS 94 / Gold; v01 (this revision) reads 93.35 / Gold under v20 bands + dropped tier cap. Methodology paper v1 can publish AP 5516 consistent with v01 (composite 93.35, CI [88, 96], Gold per §12.1 + Methodology v21 §5). Resolved.
