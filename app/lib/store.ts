...
import { pcgsAdapter, getNumistaAdapter, getArtArchiveAdapter } from "@/packages/adapters/source";
...
function buildAdapters(storage: Storage): PipelineAdapters {
  return {
    ...
    // coins → Numista; fine art → the web-search artist/work resolver.
    sources: [pcgsAdapter(), getNumistaAdapter(), getArtArchiveAdapter()],
